/**
 * @flow
 * @relayHash e2b7a9429d8d2354321d1351c3917914
 */
...
export type SongsListRefetchQueryResponse = {|
  +viewer: ?{| |};
|};
*/
...
const batch /*: ConcreteBatch*/ = {
  ...
  "text": "query SongsListRefetchQuery(\n  $lang: String!\n  $book: String!\n  $first: Int\n  $after: String\n  $order_by: String\n) {\n  viewer {\n    ...SongsList_viewer\n    id\n  }\n}\n\nfragment SongsList_viewer on Viewer {\n  songs(book: $book, language: $lang, order_by: $order_by, first: $first, after: $after) {\n    edges {\n      node {\n        id\n        book {\n          name\n        }\n        title\n        num\n        ...SongListItem_song\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n  ...SongListItem_viewer\n}\n\nfragment SongListItem_song on Song {\n  id\n  num\n  title\n  book {\n    name\n    abbrv\n  }\n}\n\nfragment SongListItem_viewer on Viewer {\n  id\n}\n"
};
